...
const MenuComponent = () => {
  ...
  return (
    <Container>
      ...
      <Button type="menu" onPress={() => router.push('/(tabs)/screens/menu/wordsPassed')}>
        <MenuIcon source={require('@/assets/images/WordImage.png')} />
        <MenuText>Word Passed</MenuText>
      </Button>

      <Button type="menu" onPress={() => router.push('/(tabs)/screens/menu/stats')}>
        <MenuIcon source={require('@/assets/images/StatsIcon.png')} />
        <MenuText>Statistic</MenuText>
      </Button>

      <Button type="menu" onPress={() => router.push('/(tabs)/screens/menu/upTimers')}>
